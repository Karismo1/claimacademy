    ...
    public class Week1
    {
        ...
        public static void ForLoops()
        {
            ...
            for (int i = 0; i < count; i++) //First statement: int i = 0; Initializes a counter i and starts at 0
                                            ...
                                            //The next loop, i will equal 10, which stops the loop, so lastexecution of loop, i is 9
        ...
        public static void ForEachLoops()
        {
            ...
            //Size of array is used to control how many times the loop runs for (loop runs from the beginning to end of array)
        ...
        {
            //See https://wwww.w3Schools.com/cs/cs_constructors.php
            //We will cover this later in the course but review later
        }

        public static void Inheritance() 
        {
            //See https://wwww.w3Schools.com/cs/cs_inheritance.php
            //We will cover this later in the course but review later
        }

        public static void Polymorphism()
        {
            //See https://wwww.w3Schools.com/cs/cs_polymorphism.php
            //We will cover this later in the course but review later
        }

        public static void Abstraction()
        { 
            //See https://wwww.w3Schools.com/cs/cs_abstract.php
            //We will cover this later in the course but review later
        }

        public static void Interfaces()
        {
            //See https://wwww.w3Schools.com/cs/cs_interface.php
            //We will cover this later in the course but review later
        }
